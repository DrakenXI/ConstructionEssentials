...
import net.drakenxi.constructionessentials.block.FacingblockBlock;
...
public class RotatorRightClickedOnBlockProcedure extends ConstructionEssentialsModElements.ModElement {
	public RotatorRightClickedOnBlockProcedure(ConstructionEssentialsModElements instance) {
		super(instance, 41);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ConstructionEssentialsMod.LOGGER.warn("Failed to load dependency entity for procedure RotatorRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ConstructionEssentialsMod.LOGGER.warn("Failed to load dependency x for procedure RotatorRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ConstructionEssentialsMod.LOGGER.warn("Failed to load dependency y for procedure RotatorRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ConstructionEssentialsMod.LOGGER.warn("Failed to load dependency z for procedure RotatorRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ConstructionEssentialsMod.LOGGER.warn("Failed to load dependency world for procedure RotatorRightClickedOnBlock!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == FacingblockBlock.block.getDefaultState().getBlock())) {
			if (((new Object() {
				...
				if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
					((PlayerEntity) entity).sendStatusMessage(new StringTextComponent((("Now facing: ") + "" + ((new Object() {
						public Direction getDirection(BlockPos pos) {
							try {
								BlockState _bs = world.getBlockState(pos);
								DirectionProperty property = (DirectionProperty) _bs.getBlock().getStateContainer().getProperty("facing");
