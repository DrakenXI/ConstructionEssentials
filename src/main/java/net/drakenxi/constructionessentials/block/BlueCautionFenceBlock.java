...
public class BlueCautionFenceBlock extends ConstructionEssentialsModElements.ModElement {
	@ObjectHolder("construction_essentials:blue_caution_fence")
	public static final Block block = null;
	public BlueCautionFenceBlock(ConstructionEssentialsModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_caution_fence");
		}
