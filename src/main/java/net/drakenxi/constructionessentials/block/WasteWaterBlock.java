...
public class WasteWaterBlock extends ConstructionEssentialsModElements.ModElement {
	@ObjectHolder("construction_essentials:waste_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("construction_essentials:waste_water_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public WasteWaterBlock(ConstructionEssentialsModElements instance) {
		super(instance, 64);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("construction_essentials:blocks/fluid"), new ResourceLocation("construction_essentials:blocks/fluid"))
				.luminosity(0).density(1).viscosity(1000)).bucket(() -> bucket).block(() -> block);
