...
public class CleanIronBarsBlock extends ConstructionEssentialsModElements.ModElement {
	@ObjectHolder("construction_essentials:clean_iron_bars")
	public static final Block block = null;
	public CleanIronBarsBlock(ConstructionEssentialsModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("clean_iron_bars");
		}
